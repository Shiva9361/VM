...
int main()
{
    std::vector<uint8_t> file = {
        ...
        0x56, 0x4D, 0x00, 0x01, // Magic
        0x01, 0x00, 0x00, 0x00, // Version =1
        0x00, 0x00, 0x00, 0x00, // EntryPoint =0 (start main)
        0x2C, 0x00, 0x00, 0x00, // ConstPoolOffset =44
        0x00, 0x00, 0x00, 0x00, // ConstPoolSize =0
        0x2C, 0x00, 0x00, 0x00, // CodeOffset =44
        0x15, 0x00, 0x00, 0x00, // CodeSize =37 bytes
        0x51, 0x00, 0x00, 0x00, // GlobalsOffset =81
        0x00, 0x00, 0x00, 0x00, // GlobalsSize =0
        0x41, 0x00, 0x00, 0x00, // ClassMetadataOffset =81 (0x51)
        0x39, 0x00, 0x00, 0x00, // ClassMetadataSize =42 bytes
        ...
        // Method: foo override
        0x03, 'f', 'o', 'o',
        0x0F, 0x00, 0x00, 0x00, // Bytecode offset = 11 (Derived::foo)
    ...
    ofstream out("test_class_inheritance.vm", ios::binary);
