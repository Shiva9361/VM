...
int main()
{
    std::vector<uint8_t> file = {
        ...
        0x23, 0x00, 0x00, 0x00, // CodeSize =37 bytes
        0x2C, 0x00, 0x00, 0x00, // GlobalsOffset =81
        0x00, 0x00, 0x00, 0x00, // GlobalsSize =0
        0x2C, 0x00, 0x00, 0x00, // ClassMetadataOffset =81 (0x51)
        0x00, 0x00, 0x00, 0x00, // ClassMetadataSize =42 bytes
